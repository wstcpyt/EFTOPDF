...
ax1.scatter (x/81.0,g,marker='*',label='Measured',color='black')
ax1.scatter (x/81.0,np.dot(AM, f_tsvd),marker=(3, 1),label='Calculated',color='red')
...
ax1.set_xlabel('Normalized wavelength',fontsize=15)
ax1.set_ylabel('IQE',fontsize=15)
#ax1.set_title('K=4',fontsize=20)
