...
f_tikhonov =svdclass.f_tikhonov(0.06,AM,g.T)
...
#ax1.set_yscale('log')
#ax.set_xscale('log')
ax1.scatter (x/17.0,f_tsvd,marker=(3, 1),label='TSVD Regularization',color='black')
ax1.scatter (x/17.0,g,marker='*',label='TSVD Regularization',color='black')
ax1.scatter (x/17.0,np.dot(AM, f_tsvd),marker='o',label='TSVD Regularization',color='red')
